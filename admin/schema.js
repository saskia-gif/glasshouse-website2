...
export const SCHEMA = [
  {
    ...
    fields:[
      ...
      {key:'contactPage', label:'Contact page', type:'group', fields:[
        ...
        {key:'heading', label:'Heading', type:'text'},
        {key:'lede', label:'Intro sentence', type:'area'},
        {key:'nameLabel', label:'Form \u2014 name box', type:'text'},
        {key:'emailFieldLabel', label:'Form \u2014 email box', type:'text'},
        {key:'messageLabel', label:'Form \u2014 message box', type:'text'},
  ...
  },
  {
    ...
    fields:[
      ...
      {key:'gallery', label:'Vertical content — pictures or films', type:'list', of:'media',
       help:'9:16. The first appears in the phone frame; the first four fill “The content” row. A film plays silently on a loop when it scrolls into view. Upload MP4 — the library will tell you if a file will not play for everyone.'},
